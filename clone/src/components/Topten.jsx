...
import top2 from '../assets/img/top2.webp'
import top3 from '../assets/img/top3.jpg'
import top4 from '../assets/img/top4.webp'
import top5 from '../assets/img/top5.jpg'
import top6 from '../assets/img/top6.webp'
import top7 from '../assets/img/top7.webp'
import top8 from '../assets/img/top8.jpg'
import top9 from '../assets/img/top9.webp'
import top10 from '../assets/img/top10.jpg'
...
function Topten() {
    ...
    const topTenContainerRef = useRef(null);

    const paginationClick = (direction) => {
        if(topTenContainerRef.current){
            const container = topTenContainerRef.current;
            const cardWidth = container.children[0].offsetWidth;

            const viewpoint = window.innerWidth;
            const vw = viewpoint / 100;
            const gap = 0.5*vw;

            let scrollAmount = 0;

            if(direction === 'right'){
                scrollAmount = container.scrollLeft + (cardWidth + gap) * 4; 
            }else{
                scrollAmount = container.scrollLeft + (cardWidth + gap) * -4;
            }
  ...
  return (
    <div>
        ...
        className='relative w-[100vw]'>
            {/* carousel header */}
            <div className='px-[3.5vw] w-full flex items-center justify-between'>
                <div className='relative font-bold text-[20px] text-white mb-2.5'>
                    Top 10 TV Shows in Thailand Today
                </div>
            ...
            <div
            ref={topTenContainerRef}
            onMouseEnter={() => {setIsInCarousel(true)}}
            onMouseLeave={() => {setIsInCarousel(false)}}
            className="relative px-[3.5vw] -mr-[3.5vw] flex">
                <div className='w-[15.5vw] flex-none'>
                    <a href="" className='flex flex-none h-[170px]'>
                        <svg className='top-10svg' id="rank-1" viewBox="-20 0 70 154">
                            <path stroke="#595959" stroke-width="4" d="M35.377 152H72V2.538L2 19.362v30.341l33.377-8.459V152z">
                            </path>
                        </svg>
                        <img src={top1} alt="" className='w-[7.5vw] h-full object-cover mr-[0.5vw]'/>
                    </a>
                </div>
                <div className='w-[15.5vw] flex-none'>
                    <a href="" className='flex flex-none h-[170px]'>
                        <svg id="rank-2" className='top-10svg' viewBox="0 0 80 154">
                            <path stroke="#595959" stroke-width="4" d="M3.72 152H113v-30.174H50.484l4.355-3.55 29.453-24.012c5.088-4.124 9.748-8.459 13.983-13.004 4.16-4.464 7.481-9.339 9.972-14.629 2.449-5.203 3.678-11.113 3.678-17.749 0-9.428-2.294-17.627-6.875-24.645-4.597-7.042-10.941-12.494-19.07-16.376C77.803 3.957 68.496 2 58.036 2 47.591 2 38.37 4.023 30.347 8.06c-8.015 4.032-14.457 9.578-19.352 16.654-4.492 6.493-7.389 13.803-8.693 21.952h34.055c1.236-3.52 3.398-6.52 6.459-8.97 3.54-2.834 8.277-4.224 14.147-4.224 5.93 0 10.552 1.537 13.76 4.681 3.181 3.12 4.791 7.024 4.791 11.594 0 4.151-1.16 7.934-3.468 11.298-2.192 3.194-5.987 7.124-11.405 11.84L3.72 122.465V152z">
                            </path>
                        </svg>
                        <img src={top2} alt="" className='w-[50%] h-full object-cover mr-[0.5vw]'/>
                    </a>
                </div>
                <div className='w-[15.5vw] flex-none'>
                    <a href="" className='flex flex-none h-[170px]'>
                        <svg id="rank-3" className='top-10svg' viewBox="0 0 80 154">
                            <path stroke="#595959" stroke-width="4" d="M3.809 41.577h33.243c1.3-2.702 3.545-4.947 6.674-6.72 3.554-2.015 7.83-3.01 12.798-3.01 5.555 0 10.14 1.11 13.723 3.376 3.839 2.427 5.782 6.283 5.782 11.315 0 4.553-1.853 8.395-5.473 11.38-3.547 2.926-8.18 4.37-13.821 4.37H41.44v28.366h16.77c5.572 0 10.275 1.227 14.068 3.711 4.02 2.633 6.071 6.581 6.071 11.616 0 5.705-1.943 9.975-5.853 12.562-3.658 2.42-8.292 3.61-13.863 3.61-5.205 0-9.82-.94-13.827-2.836-3.698-1.75-6.32-4.272-7.785-7.529H2.33c2.096 12.089 7.761 21.65 17.028 28.78C29.242 148.175 42.594 152 59.476 152c10.706 0 20.175-1.783 28.42-5.337 8.185-3.528 14.575-8.486 19.208-14.884 4.595-6.346 6.896-13.938 6.896-22.837 0-6.952-1.93-13.494-5.81-19.666-3.815-6.07-9.68-10.367-17.683-12.908l-5.46-1.735 5.353-2.04c6.659-2.538 11.667-6.338 15.083-11.412 3.431-5.096 5.142-10.806 5.142-17.181 0-8.471-2.262-15.778-6.787-21.985-4.574-6.275-10.7-11.17-18.408-14.696C77.683 3.775 69.109 2 59.687 2 44.084 2 31.515 5.816 21.91 13.415c-9 7.119-15.025 16.486-18.101 28.162z">
                            </path>
                        </svg>
                        <img src={top3} alt="" className='w-[50%] h-full object-cover mr-[0.5vw]'/>
                    </a>
                </div>
                <div className='w-[15.5vw] flex-none'>
                    <a href="" className='flex flex-none h-[170px]'>
                        <svg id="rank-4" className='top-10svg' viewBox="0 0 81 154">
                            <path stroke="#595959" stroke-width="4" d="M72 152h35.333v-30.977H128V92.497h-20.667V2H69.89L2 92.712v28.311h70V152zM36.202 92.188l35.93-47.998v47.998h-35.93z">
                            </path>
                        </svg>
                        <img src={top4} alt="" className='w-[50%] h-full object-cover mr-[0.5vw]'/>
                    </a>
                </div>
                <div className='w-[15.5vw] flex-none'>
                    <a href="" className='flex flex-none h-[170px]'>
                        <svg id="rank-5" className='top-10svg' viewBox="0 0 81 154">
                        ...
                        <img src={top5} alt="" className='w-[50%] h-full object-cover mr-[0.5vw]'/>
                    </a>
                </div>
                <div className='w-[15.5vw] flex-none'>
                    <a href="" className='flex flex-none h-[170px]'>
                        <svg id="rank-6" className='top-10svg' viewBox="0 0 81 154">
                ...
                <div className='w-[15.5vw] flex-none'>
                    <a href="" className='flex flex-none h-[170px]'>
                        ...
                        <img src={top9} alt="" className='w-[50%] h-full object-cover mr-[0.5vw]'/>
                    </a>
                </div>
                <div className='w-[15.5vw] flex-none'>
                    <a href="" className='flex flex-none h-[170px]'>
                        <svg id="rank-10" className='top-10svg' viewBox="0 0 140 154">
                            <path stroke="#595959" stroke-width="4" d="M34.757 151.55h35.869V2.976L2 19.687v30.14l32.757-8.41v110.132zm105.53 3.45c12.394 0 23.097-3.12 32.163-9.353 9.093-6.25 16.11-15.047 21.066-26.43C198.5 107.766 201 94.196 201 78.5c0-15.698-2.5-29.266-7.484-40.716-4.955-11.384-11.973-20.18-21.066-26.431C163.384 5.119 152.681 2 140.287 2c-12.393 0-23.096 3.12-32.162 9.353-9.093 6.25-16.11 15.047-21.066 26.43-4.984 11.45-7.484 25.02-7.484 40.717 0 15.698 2.5 29.266 7.484 40.716 4.955 11.384 11.973 20.18 21.066 26.431 9.066 6.234 19.769 9.353 32.162 9.353zm0-31.368c-7.827 0-13.942-4.147-18.15-12.178-4.053-7.736-6.047-18.713-6.047-32.954s1.994-25.218 6.047-32.954c4.208-8.03 10.323-12.178 18.15-12.178 7.827 0 13.943 4.147 18.15 12.178 4.053 7.736 6.048 18.713 6.048 32.954s-1.995 25.218-6.047 32.954c-4.208 8.03-10.324 12.178-18.15 12.178z">
                            </path>
                        </svg>
                        <img src={top10} alt="" className='w-[50%] h-full object-cover mr-[0.5vw]'/>
                    </a>
                </div>

                <div aria-hidden className='w-[15.5vw] flex-none'>
                    <a href="" className='flex flex-none h-[170px]'>
                        <svg className='top-10svg' id="rank-1" viewBox="-20 0 70 154">
                            <path stroke="#595959" stroke-width="4" d="M35.377 152H72V2.538L2 19.362v30.341l33.377-8.459V152z">
                            </path>
            ...
            <div
                onclick={() => {paginationClick('right')} }
                className='absolute h-[170px] w-[3.5vw] right-0 bottom-0 group z-20'>
                <FaChevronRight
                    className={`absolute z-10 scale-150 right-[1.75vw] top-1/2 translate-y-[-50%] transition-all duration-100 linear group-hover:scale-180
                    ${isInCarousel ? 'opacity-100 pointer-events-auto cursor-pointer' : 'opacity-0 pointer-events-none'}`}/>
                <div className="absolute cursor-pointer w-full h-full transition-all duration-100 linear bg-black/40 group-hover:bg-black/60"></div>
            </div>
        </div>
    </div>
  )
